              ...
              <div className="p-8">
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-gray-700">Acesso a vagas de estágio</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                ...
                <div className="space-y-3">
                  <button type="button" onClick={onStartAsStudent}
                    className="w-full py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition font-semibold text-lg flex items-center justify-center gap-2">
                    Entrar como Estudante
                    <ArrowRight className="w-5 h-5" />
                  </button>
                  <button type="button" onClick={onCreateStudentAccount}
            ...
            <div className="group bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-transparent hover:border-purple-600">
              ...
              <div className="p-8">
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">Publique vagas de estágio</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                ...
                <div className="space-y-3">
                  <button type="button" onClick={onStartAsCompany}
                    className="w-full py-4 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition font-semibold text-lg flex items-center justify-center gap-2">
                    Entrar como Empresa
                    <ArrowRight className="w-5 h-5" />
                  </button>
                  <button type="button" onClick={onCreateCompanyAccount}
                    className="w-full py-3 border-2 border-gray-200 text-gray-700 rounded-xl hover:border-purple-600 hover:text-purple-600 transition font-semibold">
                    Cadastrar Empresa
                  </button>
                </div>
              </div>
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Conectamos estudantes e empresas de forma eficiente e transparente</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Todas as vagas e perfis são verificados pela nossa equipe</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Para estudantes é totalmente grátis, sempre</p>
              </div>
            </div>
          </div>
        </div>
